...
class AI {
    ...
    evaluate() {
        ...
        for (let square = 0; square < 64; square++) {
            const piece = this.board.getPiece((0, types_1.unsafeSquare)(square));
            if (piece) {
                const value = types_1.PIECE_VALUES[piece.type];
                const positionBonus = this.getPositionBonus((0, types_1.unsafeSquare)(square), piece.type, piece.color);
