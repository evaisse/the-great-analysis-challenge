...
class DrawDetection {
  static bool isDrawByRepetition(Board board) {
    ...
    final halfmoveClock = board.get_halfmoveClock_internal();
  ...
  static bool isDrawByFiftyMoves(Board board) {
    return board.get_halfmoveClock_internal() >= 100;
  }
...
extension BoardHalfmove on Board {
  int get_halfmoveClock_internal() {
    // We need to expose _halfmoveClock
    return get_halfmoveClock_val();
  }
}
