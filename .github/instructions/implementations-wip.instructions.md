---
applyTo: "implementations-wip/**"
---

# Work-in-Progress Chess Engine Implementation Instructions

> **Note:** These are work-in-progress implementations being graduated to `implementations/` once they pass all tests. All the same rules apply. When an implementation is ready, move it to `implementations/` — do NOT modify root infrastructure.
...
- Each implementation lives in `implementations-wip/<language>/` and MUST include: `Dockerfile`, `Makefile`, `chess.meta`, `README.md`
